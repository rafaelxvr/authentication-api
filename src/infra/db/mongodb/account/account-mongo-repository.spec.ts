...
describe('Account Mongo Repository', () => {
  ...
  describe('loadByToken()', () => {
    test('Should return an account loadByToken without role', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@mail.com',
    ...
    test('Should return an account loadByToken with role', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@mail.com',
    ...
    test('Should return an account loadByToken if role is application and an apiKey is passed', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@mail.com',
      ...
      const account = await sut.loadByToken('any_key', 'application')
